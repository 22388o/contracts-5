...
const GasToken1Address = "0xade9F9A7d2cae453312f15134E4C05b39EBe3Bd7"

const oldTokenContractABI = [
	{
		"inputs": [
			{
				"internalType": "string",
...
const oldTokenContractAddress = "0xa11f54Ed40280B446bbf86e65c0a676Da2FAa4fd"
...
const TokenContractAddress = "0xa11f54Ed40280B446bbf86e65c0a676Da2FAa4fd"
...
window.addEventListener('load', async () => {
    ...
    if (window.ethereum) {
        ...
        try {
			...
			Token = TokenContract.at(TokenContractAddress);
...
async function balanceOf() {
    ...
    let promise = new Promise(async (res, rej) => {
		// 0xBD3b7A27bBb3B2Cf9c8276E3504025AA993D8075
		Token.balanceOf('0xBD3b7A27bBb3B2Cf9c8276E3504025AA993D8075', function(error, result) {
			if (!error)
				res(result);
			else{
				rej(error);
	...
	let result = await promise;
	document.getElementById('data').innerHTML = parseInt(result)/100;
    return result;
}
...
async function burn() {
    ...
    let promise = new Promise(async (res, rej) => {
		...
		Token.burn(web3.toHex(1000000000000000000),function(error, result) {
			if (!error)
				res(result);
			else{
				rej(error);
	...
	let result = await promise;
	document.getElementById('data').innerHTML = parseInt(result);
    return result;
}
